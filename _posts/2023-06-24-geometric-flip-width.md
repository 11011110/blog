...
---
I recently posted here about the [flip-width of geometric graphs]({{site.baseurl}}{% post_url 2023-02-20-geometric-graphs-unbounded %}), and to readers of that post, my new preprint "[Geometric Graphs with Unbounded Flip-Width](https://ics.uci.edu/~eppstein/pubs/p-flipwidth.html)" ([arXiv:2306.12611](http://arxiv.org/abs/2306.12611), with Rose McCarty, to appear in CCCG 2023) will look very familiar. It even has the same title! However, the process of turning it into a paper led to some improvements. Let me summarize them briefly here.
