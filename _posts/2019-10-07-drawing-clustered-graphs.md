...
Now, in my newest preprint, "[C-planarity testing of embedded clustered graphs with bounded dual carving-width](https://ics.uci.edu/~eppstein/pubs/p-cplanar.html)" (with the same authors, [arXiv:1910.02057](https://arxiv.org/abs/1910.02057)), we've eliminated the dependence on the number of clusters (using a different width parameter) and found a fixed-parameter tractable algorithm with just a single parameter.
