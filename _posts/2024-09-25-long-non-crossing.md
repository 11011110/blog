...
This is the subject of a recent paper by ten authors including myself: "[Noncrossing longest paths and cycles](https://ics.uci.edu/~eppstein/pubs/p-nonxlong.html)", by Greg Aloupis, Ahmad Biniaz, Jit Bose, Jean-Lou De Carufel, me, Anil Maheshwari, Saeed Odak, Michiel Smid, Csaba Tóth, and Pavel Valtr, most of whom worked together on this at the 10th Annual Workshop on Geometry and Graphs in Barbados last year. It was presented last week at Graph Drawing 2024, for which the [program has links to preliminary versions of all papers](https://graphdrawing.github.io/gd2024/pages/program/), at least until the published proceedings is ready.
