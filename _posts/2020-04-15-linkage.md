...
[![Showa bowl from above](https://www.ics.uci.edu/~eppstein/pix/radialbowl/RadialBowl-m.jpg){: style="border-style:solid;border-color:black;background-color:black"}](https://www.ics.uci.edu/~eppstein/pix/radialbowl/index.html)
...
* In [the previous batch of photos]({{site.baseurl}}{% post_url 2020-03-29-backyard-sunlight %}) the stripy shadows were artificial (caused by the slats of a trellis shading our patio) but this time they're natural: they come from the fronds of one of the palm trees in our garden, shading the trunk of the tree ([$$\mathbb{M}$$](https://mathstodon.xyz/@11011110/104005420231873385)).
  ...
  {: style="text-align:center"}
[![Palm tree casts shadows on itself](https://www.ics.uci.edu/~eppstein/pix/palmshadow/PalmShadow-m.jpg){: style="border-style:solid;border-color:black;background-color:black"}](https://www.ics.uci.edu/~eppstein/pix/palmshadow/index.html)
