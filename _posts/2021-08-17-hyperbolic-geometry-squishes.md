...
But my newest preprint, "[Limitations on realistic hyperbolic graph drawing](https://ics.uci.edu/~eppstein/pubs/p-realistic.html)" ([arXiv:2108.07441](https://arxiv.org/abs/2108.07441)) argues that for other kinds of graphs, this idea of drawing a graph hyperbolically and then viewing it through a Euclidean model of hyperbolic geometry has some significant limitations, in some ways more severe than the limitations imposed by making Euclidean drawings (and then using some other method for focus+context).
