...
One thing we know about matrices is that they have a [rank](Rank (linear algebra)), the dimension of the vector space generated by their rows or columns. But tensors also have a notion of rank. The rank of a tensor is the minimum number of terms needed to express it as a sum of products
